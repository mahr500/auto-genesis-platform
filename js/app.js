...
document.getElementById('agent-onboard-form').addEventListener('submit', function(e) {
    ...
    if (!name || !email || !type || proof.length < 10) { // تحقق من محتوى "إثبات المهارة"
        alert(lang === 'ar' ? 'يرجى ملء جميع الحقول المطلوبة، وكتابة إجابة مفصلة في "إثبات المهارة".' : 'Please fill all required fields and provide a detailed answer in "Proof of Skill".'); // Fixed message
        return;
    }
